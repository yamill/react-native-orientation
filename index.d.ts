declare module 'react-native-orientation' {
  class Orientation {
    ...
    static addSpecificOrientationListener(
      handler: (orientation: OrientationType) => void
    ): void;

    static removeSpecificOrientationListener(
      handler: (orientation: OrientationType) => void
    ): void;

    static getInitialOrientation(): OrientationType;

    static getOrientation(cb: (err: any, orientation: string) => void): void;

    static getSpecificOrientation(
      cb: (err: any, orientation: string) => void
    ): void;
